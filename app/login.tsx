              ...
              <View style={styles.form}>
                 ...
                 <View style={styles.rowGap}>
                    <View style={[styles.inputGroup, {flex: 1}]}>
                        ...
                        <TextInput style={styles.input} placeholder="Ahmet" placeholderTextColor="#9ca3af" />
                    </View>
                    <View style={[styles.inputGroup, {flex: 1}]}>
                        <Text style={styles.label}>Soyad</Text>
                        <TextInput style={styles.input} placeholder="Yılmaz" placeholderTextColor="#9ca3af" />
                    </View>
                 </View>

                 <View style={styles.inputGroup}>
                    <Text style={styles.label}>Favori Sporlar</Text>
                    <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{gap: 8}}>
                        <TouchableOpacity style={[styles.chip, styles.chipActive]}>
                            <MaterialIcons name="sports-soccer" size={18} color="white" />
                            <Text style={styles.chipTextActive}>Futbol</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.chip}>
                            <MaterialIcons name="sports-basketball" size={18} color={isDark ? '#d1d5db' : '#4b5563'} />
                            <Text style={styles.chipText}>Basketbol</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.chip}>
                            <MaterialIcons name="sports-tennis" size={18} color={isDark ? '#d1d5db' : '#4b5563'} />
                            <Text style={styles.chipText}>Tenis</Text>
                        </TouchableOpacity>
                    </ScrollView>
                 </View>

                 <TouchableOpacity style={[styles.primaryButton, {marginTop: 8}]} onPress={() => router.replace('/(tabs)')}>

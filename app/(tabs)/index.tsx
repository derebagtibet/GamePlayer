    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={styles.header}>
        <View style={styles.userInfo}>
          <Image
            source={{ uri: 'https://ui-avatars.com/api/?name=Can+Yilmaz&background=random' }}
            style={styles.avatar}
          />
          <View>
            <Text style={styles.welcomeText}>Hoş geldin,</Text>
            <Text style={styles.userName}>Tibet Derebağ</Text>
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.horizontalScroll}>
            <EventCard
              ...
              time="20:00 - 21:00"
              location="Levent Tesisleri"
              tag="BUGÜN"
              bgImage="https://images.unsplash.com/photo-1529900748604-07564a03e7a6?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60"
            />
            <EventCard
              isDark={isDark}
              title="Basketbol 3v3"
              ...
              tag="YARIN"
              tagColor="orange"
              bgImage="https://images.unsplash.com/photo-1546519638-68e109498ee2?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60"
            />
          </ScrollView>
        </View>
...
const EventCard = ({ isDark, title, time, location, tag, tagColor = COLORS.primary, bgImage }: any) => {
    const styles = getStyles(isDark);
    const router = useRouter();
    return (
        <TouchableOpacity 
...
const TeamCard = ({ isDark, name, distance, need, needType }: any) => {
    const styles = getStyles(isDark);
    const router = useRouter();
    return (
        <TouchableOpacity 
          ...
          onPress={() => router.push({
            pathname: '/event-details',
            params: { title: name, location: distance, time: need }
          })}
        >
